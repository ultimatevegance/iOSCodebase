//
//  MSScrollingButtonBarView.swift
//  iOSAppTemplateSwift
//
...
open class MSScrollingButtonBarView: UICollectionView {
    ...
    open func moveTo(index: Int, animated: Bool, swipeDirection: MSPageScrollDirection, pagerScroll: PagerScroll) {
        selectedIndex = index
    ...
    open func updateSelectedBarPosition(_ animated: Bool, swipeDirection: MSPageScrollDirection, pagerScroll: PagerScroll) {
